...
let urlData = '';  // 裝 API 的主要資料
let picData = []; // 合成圓餅圖前的基本資料
let newAry = [];

//網路請求 Axios
let urlPath = "https://raw.githubusercontent.com/HsuehFan/json/main/travel.json"; //api 串接路衡
